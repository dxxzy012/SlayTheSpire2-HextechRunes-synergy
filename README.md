...
[![版本](https://img.shields.io/badge/版本-0.5.5-绿色)]()
...
- 🗺️ **全地图悬浮提示** 🗺️ —— 任意已拥有符文上悬浮即可查看羁绊进度与门槛详情
...
- ⚡ **多项数值平衡** ⚡ —— 怪物海克斯数量增加，让每一场战斗都充满策略与抉择，如果你害怕选择移除怪物海克斯，你也要接受一些损失。
